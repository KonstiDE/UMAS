...
public enum BuildPointCloud implements AgisoftParameter {
    ...
    ACCURACY("quality", List.of("Ultra High", "High", "Medium", "Low", "Lowest"), 1),
    DEPTH_FILTERING("depthfiltering", List.of("Disabled", "Mild", "Moderate", "Aggressive"), 1),
    REUSE_DEPTH_MAPS("reusedepthmaps", List.of("True", "False"), 0),
    CALCULATE_POINT_COLORS("calculatepointcolors", List.of("True", "False"), 0),
