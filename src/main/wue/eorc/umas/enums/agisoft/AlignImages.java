...
public enum AlignImages implements AgisoftParameter {
    ...
    ACCURACY("accuracy", List.of("Highest", "High", "Medium", "Low", "Lowest"), 1),
    ...
    KEY_POINT_LIMIT("keypointlimit", List.of("40000"), 0),
    KEY_POINT_LIMIT_PER_MPX("keypointlimitpermpx", List.of("1000"), 0),
    TIE_POINT_LIMIT("tiepointlimit", List.of("4000"), 0),
    APPLY_MASKS_TO("", List.of("None"), 0),
    EXCLUDE_STAT_TIE_POINTS("excludestationarytiepoints", List.of("True", "False"), 0),
    GUIDED_MATCHING("guidedimagematching", List.of("True", "False"), 1),
