...
public enum Sensor {
    ...
    FIXEDM3M("FixedM3M", List.of(ImageType.RGB, ImageType.MULTISPECTRAL, ImageType.CALIBRATION)),
    ...
    MXDUAL("MXDUAL", List.of(ImageType.MULTISPECTRAL, ImageType.CALIBRATION)),
    D2M("D2M", List.of(ImageType.RGB)),
    ALTUM("ALTUM", List.of(ImageType.RGB, ImageType.MULTISPECTRAL, ImageType.CALIBRATION, ImageType.IR)),
    ALTUMPT("ALTUMPT", List.of(ImageType.MULTISPECTRAL, ImageType.CALIBRATION)),
